package com.vertuoso.usuario.infrastructure.security;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    @Override
    public void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws UnauthorizedException {
        ...
        try {
            ...
            throw new UnauthorizedException("Erro token inválido ou expirado", ex.getCause());
        } catch( ServletException | IOException ex) {
            throw new ResourceNotFoundException("Erro ao realizar a autenticação", ex);
        }
    }
}
